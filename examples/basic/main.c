...
int main()
{
    ...
    for (size_t i = 0; i < num_transitions; i++) {
        ...
        fa_error_t err = fa_auto_create_trans(
                            automaton,
                            transitions[i].src,
                            transitions[i].dest,
    ...
    /* -----------------------------
       ...
       ----------------------------- */
    fa_auto_export_dot_file(automaton, "../examples/basic/basic_automaton.dot");


    /* -----------------------------
       8. Generate the corresponding json file
       ----------------------------- */
    fa_auto_export_json_file(automaton, "../examples/basic/basic_automaton.json");
